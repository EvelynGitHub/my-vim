...
exe 'hi CursorLine   guifg=NONE      guibg=#555555   ctermfg=NONE   ctermbg=234       gui=none      cterm=none'
...
exe 'hi PMenuThumb   guifg=fg        guibg=#767676   ctermfg=15     ctermbg=8       gui=none      cterm=none'
...
" TabLineFill = Cor de preenchimento (fundo) da Tab (linha onde fica o nome do arquivo)'
...
exe 'hi VertSplit    guifg=#8a8a8a   guibg=#b2b2b2   ctermfg='s:bg'    ctermbg='s:bg2'       gui=none    cterm=none'
" Folded = cor de quando dobramos/minimizamos o código
exe 'hi Folded       guifg=fg        guibg=#585858   ctermfg=none     ctermbg=236       gui=none      cterm=none'
...
exe 'hi ErrorMsg     guifg=#ff8787   guibg=NONE      ctermfg=9    ctermbg=NONE      gui=none      cterm=none'
